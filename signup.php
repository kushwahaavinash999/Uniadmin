        ...
        <form action="register.php" method="post">
          <div class="user-details">
            ...
            <div class="input-box">
              ...
              <input type="tel" name="phone_no" placeholder="0123456789" pattern="[0-9]{10}">
            </div>
            <div class="input-box">
            ...
            <div class="input-box">
              ...
              <input type="password" name="C_password" placeholder="Enter your Confirm password" required />
            </div>
            <div class="input-box">
